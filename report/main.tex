...
\include{sections/Preamble/Abbreviations}
\include{sections/Preamble/Abstract}
\include{sections/Preamble/Acknowledgements}
\include{sections/Preamble/Consent-To-Share}
...
\include{sections/C1 - Introduction/Introduction}
\include{sections/C2 - LitReview/LitReview}
\include{sections/C3 - Methodology/Methodology}
\include{sections/C4 - Requirements/Requirements}
\include{sections/C5 - Design/Design}
\include{sections/C6 - Implementation/Implementation}
\include{sections/C7 - Testing/Testing}
\include{sections/C8 - Evaluation/Evaluation}
\include{sections/C9 - Conclusion/Conclusion}
...
\include{sections/Appendix/B}
\include{sections/Appendix/C}
\include{sections/Appendix/D}
\include{sections/Appendix/E}
