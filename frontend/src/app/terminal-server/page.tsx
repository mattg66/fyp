    ...
    return (
        <>
            ...
            >
                ...
                <AddForm setAddModal={setAddModal} setTerminalServers={setTerminalServers} terminalServers={terminalServers} isOpen={addModal} />
            </Modal>
        </>
    )
}
function AddForm({setAddModal, setTerminalServers, terminalServers, isOpen} : {setAddModal:  (value: boolean) => void, setTerminalServers: (value: TerminalServer[]) => void, terminalServers: TerminalServer[], isOpen: boolean}) {
